                ...
                <div class="card-content">
                    <div class="media">
                        <div class="media-content">
                            ...
                            <p class="subtitle is-6">{{ Str::limit($producto->descripcion, 20, '...'); }} <a
                                    href="{{url('/producto/'.$producto->id ) }}">Detalles</a></p>
                            @else
                            <p class="subtitle is-6">{{ $producto->descripcion }} <a
                                    href="{{ url('/producto/'.$producto->id ) }}">Detalles</a></p>
                            @endif

                            <div class="existencia">
                                <progress class="progress is-small is-primary mb-1"
                                    value="{{ $producto->totalSacos * 100 / 20 }}" max="100">20%</progress>
                                ...
                                <div class="indicadores is-flex is-justify-content-space-between">
                                    ...
                                    <div class="porcentaje">
                                        <p class="is-subtitle is-size-6 mt-0">{{ $producto->totalSacos * 100 / 20 }}%
                                            Disponible</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="columns is-1">
                            <div class="column is-half">
                                ...
                                <div class="columns is-multiline is-gapless">
                                    ...
                                    <div class="column is-full">
                                        <p class="is-subtitle has-text-primary is-size-5">${{ $producto->precioSaco }}
                                        </p>
                                    </div>
