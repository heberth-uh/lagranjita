                        ...
                        <div class="media-content">
                            ...
                            <div class="existencia">
                                ...
                                <div class="indicadores is-flex is-justify-content-space-between">
                                    <div class="existencia">
                                        <p class="is-subtitle is-size-7 mt-0">Existenia: {{ $producto->totalSacos }}</p>
                                    </div>
                                    <div class="porcentaje">
                                        <p class="is-subtitle is-size-7 mt-0">{{ $producto->totalSacos * 100 / 20 }}%
                                            Disponible</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="columns is-1">
                            ...
                            <div class="column is-half">
                                ...
                                <div class="columns is-multiline is-gapless">
                                    ...
                                    <div class="column">
                                        <p class="is-subtitle has-text-primary is-size-6">$ {{ $producto->precioKg }}</p>
                                    </div>
                                    <div class="column is-three-quarters mt-2">
                                        <input class="input is-primary is-size-7" type="text" placeholder="Cantidad">
                                    </div>
