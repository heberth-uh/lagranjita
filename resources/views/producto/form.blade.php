<div class="field">
    ...
    <div class="control">
        <input class="input" type="text" value="{{ $producto->nombre }}" placeholder="Ingrese el nombre del producto"
            name="nombre">
    </div>
</div>
    ...
    <div class="control">
        <div class="select">
            <select class="form-control" name="etapa">
                <option value="iniciación" {{ $producto->etapa == "iniciación" ? "selected" : "" }}>Iniciación</option>
                <option value="desarrollo" {{ $producto->etapa == "desarrollo" ? "selected" : "" }}>Desarrollo</option>
                <option value="finalización" {{ $producto->etapa == "finalización" ? "selected" : "" }}>Finalización
                </option>
            </select>
        </div>
    </div>
    ...
    <div class="control">
        <div class="select">
            <select class="form-control" name="categoria">
                ...
                <option value="rumiantes" {{ $producto->categoria == "rumiantes" ? "selected" : "" }}>Ruminates</option>
                <option value="cereales y maíz" {{ $producto->categoria == "cereales y maíz" ? "selected" : "" }}>
...
<div class="columns">
    ...
    <div class="column is-half">
        <div class="field">
            ...
            <div class="control">
                <input class="input" type="number" value="{{ $producto->precioSaco }}" placeholder="Precio por costal"
                    name="precioSaco">
            </div>
        </div>
    </div>
...
<div class="field">
    ...
    <div class="control">
        <input class="input" type="number" value="{{ $producto->totalSacos }}" placeholder="Cantidad de sacos"
            name="totalSacos">
    </div>
</div>
...
<div class="field">
    ...
    <div class="control">
        <input class="input" type="number" value="{{ $producto->totalKg }}" placeholder="Cantidad en Kg" name="totalKg">
    </div>
</div>
